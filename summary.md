...
- **Planned Features:**
  ...
  - **Add Assignment** — assign the teacher to a class, section, subject, and role:
    ...
    - **Subject Teacher** — teaches a specific subject
...
| Feature | Description |
|---------|-------------|
| Login / Logout | Email + Password, role-based redirect |
| Forgot Password (OTP) | 3-step OTP flow |
| Admin Dashboard | Stats cards, upcoming exams, enrollment chart |
| School Profile Settings | Edit school info |
| Session Management | Create, set current, delete |
| Class & Section Management | Add classes, add sections |
| Subject Management | Add subjects per class-section-session |
| Grading Scheme | Create schemes + define grade ranges |
| Holistic Parameter Setup | 6 categories with sub-parameters |
| Teacher Management | Create accounts, assign to classes/subjects |
| Student Management | Add, edit, enroll, bulk import, export CSV |
| Calendar | Generate, mark holidays, view working days |
| Daily Attendance | Mark present/absent with monthly grid view |
| Attendance Reports | Monthly grid + summary with percentages |
| Exam Management | Create exams, add subject schedules |
| Marks Entry | Excel-like grid with auto-grade calculation |
| Marks Statistics | Average, highest, lowest, pass % |
| Holistic Rating Entry | Monthly rating grid (1-10 scale) |
| Monthly/Exam/Annual Reports | View report data on screen |
| Teacher Dashboard | Assigned classes, attendance status, quick actions |
| Teacher Attendance Grid | Monthly grid with checkboxes per day |
| Teacher Marks Grid | Excel-style multi-subject marks entry |

### Phase 2 — Enhancements
| Feature | Description |
|---------|-------------|
| PDF Report Cards | Downloadable PDF reports with school header and logo |
| Bulk PDF Generation | Generate report cards for entire class at once |
| Notifications | In-app notification bell for teachers and admins |
| Data Export | Export attendance and marks data as CSV/Excel |
| Print-Friendly Views | Print-optimized layouts for all reports |

### Phase 3 — Advanced Features
| Feature | Description |
|---------|-------------|
| Fee Management | Fee collection, payment tracking, receipts |
| Timetable / Period Scheduling | Class timetable management |
| SMS / WhatsApp Notifications | Parent notifications for attendance and results |
| Student Promotion | Session rollover — promote students to next class |
| Library Management | Book issue/return tracking |
| Transport Management | Bus routes and student transport |
| Mobile App | Teacher mobile app for attendance and marks on the go |
...
1. **Which features are most important for launch?** — Help us prioritize Phase 1
2. **Any missing workflows?** — Are there daily tasks that are not covered above?
3. **What reports do you need?** — Any specific report formats required by the school board?
4. **Parent access needed?** — Should parents be able to view attendance/marks/reports?
5. **Any specific UI preferences?** — How should the mobile view look? Any color/branding preferences?
6. **Integration needs?** — Should it integrate with any existing systems (SMS gateway, payment gateway, etc.)?

Please share your feedback so we can finalize the feature plan and begin development.
