-- ============================================================================
-- Migration: 003_seed_data.sql  (Postgres edition)
-- Description: Combines original migrations 003 (roles + admin user) and
--              007 (holistic templates) into one seed step. The MySQL
--              `INSERT IGNORE` becomes `ON CONFLICT DO NOTHING`. After
--              inserting rows with explicit IDs we bump the underlying
--              sequences so future auto-generated IDs don't collide.
-- Created: 2026-05-04
-- ============================================================================
...
-- ─── Default holistic templates (4 stages × 5 parameters × 5 sub-params) ──
INSERT INTO default_holistic_templates (stage, parameter_name, parameter_sort_order, sub_parameter_name, sub_parameter_sort_order) VALUES
-- ═══ FOUNDATIONAL ═══
